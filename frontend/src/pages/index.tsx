  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine - Reserving tables made easy for customers, managing reservations and menus simplified for restaurant staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine - Reserving tables made easy for customers, managing reservations and menus simplified for restaurant staff.`}
            </Text>
            <Box
